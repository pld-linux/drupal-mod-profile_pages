...
Moduł wyświetlający każdego użytkownika na stronie z wypełnionym
pewnym polem profile_field, podobnie do katalogu strony użytkowników z
podaną tą informacją (np. użytkowników z kontami komunikatora AOL
